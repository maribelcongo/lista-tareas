...
const CambiadorFondo = () => {
  ...
  const imagenes = ['url("https://i.pinimg.com/originals/04/6c/43/046c43bfa1fef37cc6775bed8a61b449.jpg")', 'url("assets/fondo2.png")'];
...
const cambiarColor = () => {
  ...
  return (
    <div className="btnCambio">
      <button onClick={cambiarColor} className="LuPalette"><LuPalette /></button>
    </div>
  );
};
